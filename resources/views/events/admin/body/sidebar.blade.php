        ...
        <div class="navbar-vertical-content">
            <ul class="navbar-nav flex-column" id="navbarVerticalNav">
                ...
                <li class="nav-item">
                    ...
                    <div class="nav-item-wrapper">
                        <a
                            class="nav-link dropdown-indicator label-1 {{ Request::is('projects/admin/project*') || Request::is('projects/admin/task*')? '' : 'collapsed' }}"
                            href="#nv-project-managementz"
                            role="button"
                            data-bs-toggle="collapse"
                            aria-expanded="{{ Request::is('projects/admin/project*') || Request::is('projects/admin/task*') ? 'true' : 'false' }}"
