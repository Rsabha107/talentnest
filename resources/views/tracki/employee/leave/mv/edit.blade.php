...
<div class="modal-body">
    ...
    <div class="col-md-12">
        ...
        <div class="col-md-12">
            ...
            <textarea style="height: 100px;"  maxlength="500" required name="reason" id="edit_reason" class="form-control tinymce1" data-tinymce="{}" placeholder="">{{$employee_leave->reason}}</textarea>
        </div>
        <!-- </div> -->
    </div>
    <!-- end of left div -->
