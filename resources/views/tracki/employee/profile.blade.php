                        ...
                        <div class="col">
                            <div class="card h-100 hover-actions-trigger">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center mb-2"><span class="fa-solid far fa-address-card me-2 text-700 fs--1 fw-extra-bold"></span>
                                        <p class="mb-0 fw-bold fs-9">IBAN : <span class="fw-semibold text-body-tertiary text-opactity-85 ms-1">{{$emp->banks?->iban}}</span></p>
                                    </div>
                                    <div class="d-flex align-items-center mb-2"><span class="fa-solid fas fa-birthday-cake me-2 text-700 fs--1 fw-extra-bold"></span>
                                        <p class="mb-0 fw-bold fs-9">SWIFT code : <span class="fw-semibold text-body-tertiary text-opactity-85 ms-1">{{$emp->banks?->swift_code}}</span></p>
                                    </div>
