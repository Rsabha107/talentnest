    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="col-md-12 mb-3">
                ...
                <input name="net_salary" maxlength="50" id="edit_net_salary" class="form-control" type="text" placeholder="" value="{{$employee_salary->net_salary}}" required>
                <!-- <div class="invalid-feedback">This field is required.</div> -->
            </div>
            <div class="col-md-12 mb-3">
                ...
                <select class="form-select" name="payroll_cycle_id" required>
                    ...
                    @if ($employee_salary->payroll_cycle_id == $item->id )
