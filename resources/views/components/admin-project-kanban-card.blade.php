        ...
        <div class="content kanban-content">
            {{-- <div class="kanban-header">
                <div class="row gx-0 justify-content-between justify-content-md-start">
                    <div class="col-auto">
                        <div class="dropdown">
                            <button class="btn btn-link text-decoration-none text-body-emphasis fs-8 ps-0" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <span class="fs-7 me-2">Phoenix</span><span class="fas fa-angle-down text-body-quaternary d-inline-block" data-fa-transform="up-2" style="min-width: 12px"></span></button>
                    ...
                    <div class="col-auto d-flex align-items-center">
                        ...
                        <button class="btn btn-primary ms-4 fs-10 px-3"><span class="fas fa-user-plus d-inline-block" style="min-width: 14px"></span><span class="d-none d-sm-inline ms-2">invite</span></button>
                    </div>
                            ...
                            <div class="card sortable-item hover-actions-trigger">
                                <div class="card-body py-3 px-3">
                                    <div class="position-relative mb-2 overflow-hidden rounded" style="height:200px; width:100%">
                                        <div class="bg-holder" style="background-image:url({{ asset('assets/img/kanban/1.jpg')}}"> 
                                            <!-- ../../assets/img/kanban/1.jpg);"> -->
                                        </div>
                                        <!--/.bg-holder-->
                    ...
                    <div class="kanban-items-container" data-sortable="data-sortable">
                        ...
                        <div class="sortable-item-wrapper border-bottom border-translucent px-2 py-2">
                            <div class="card sortable-item hover-actions-trigger">
                                <div class="card-body py-3 px-3">
                                    <div class="position-relative mb-2 overflow-hidden rounded" style="height:200px; width:100%">
                                        <div class="bg-holder" style="background-image:url({{ asset('assets/img/kanban/glass.jpg')}});">
                                        </div>
                                        <!--/.bg-holder-->
                    ...
                    <div class="kanban-items-container" data-sortable="data-sortable">
                        ...
                        <div class="sortable-item-wrapper border-bottom border-translucent px-2 py-2">
                            <div class="card sortable-item hover-actions-trigger">
                                <div class="card-body py-3 px-3">
                                    <div class="position-relative mb-2 overflow-hidden rounded" style="height:200px; width:100%">
                                        <div class="bg-holder" style="background-image:url({{ asset('assets/img/kanban/wall.jpg')}});">
                                        </div>
                                        <!--/.bg-holder-->
                    ...
                    <div class="kanban-items-container" data-sortable="data-sortable">
                        ...
                        <div class="sortable-item-wrapper border-bottom border-translucent px-2 py-2">
                            <div class="card sortable-item hover-actions-trigger">
                                <div class="card-body py-3 px-3">
                                    <div class="position-relative mb-2 overflow-hidden rounded" style="height:200px; width:100%">
                                        <div class="bg-holder" style="background-image:url({{ asset('assets/img/kanban/home.jpg')}});">
                                        </div>
                                        <!--/.bg-holder-->
