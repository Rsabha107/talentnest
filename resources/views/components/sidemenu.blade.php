                        ...
                        <div class="parent-wrapper label-1">
                            <ul
                                        ...
                                        <ul
                                            ...
                                            <li class="nav-item">
                                                <a
                                                    ...
                                                    href="{{ route('tracki.payroll.payment') }}">
                                                    <div class="d-flex align-items-center">
                                ...
                                <li class="nav-item">
                                    ...
                                    <div class="parent-wrapper">
                                        <ul
                                            class="nav collapse parent {{ Request::is('tracki/employee/letter/*') ? 'show' : '' }}"
                                            data-bs-parent="#letter"
                                            id="nv-letter">
                                            <li class="nav-item">
                                                <a
                                                    class="nav-link {{ Request::is('tracki/employee/letter/generate') ? 'active' : '' }}"
                                                    href="{{ route('tracki.employee.letter.generate') }}">
                                                    <div class="d-flex align-items-center">
                                            ...
                                            <li class="nav-item">
                                                <a
                                                    class="nav-link {{ Request::is('tracki/employee/letter') ? 'active' : '' }}"
                                                    href="{{ route('tracki.employee.letter') }}">
                                                    <div class="d-flex align-items-center">
                                ...
                                <li class="nav-item">
                                    <a
                                        class="nav-link {{ Request::is('tracki/audit/hrms') ? 'active' : '' }} label-1"
                                        href="{{route('tracki.audit.hrms')}}" role="button">
                                        <div class="d-flex align-items-center">
                                ...
                                <li class="nav-item">
                                    ...
                                    <div class="parent-wrapper">
                                        <ul
                                            ...
                                            <li class="nav-item">
                                                <a
                                                    class="nav-link {{ Request::is('tracki/setting/prefix') ? 'active' : '' }}"
                                                    href="{{ route('tracki.setting.prefix') }}">
                                                    <div class="d-flex align-items-center">
                                            ...
                                            <li class="nav-item">
                                                <a
                                                    class="nav-link {{ Request::is('tracki/setting/elementset') ? 'active' : '' }}"
                                                    href="{{ route('tracki.setting.elementset') }}">
                                                    <div class="d-flex align-items-center">
                                            ...
                                            <li class="nav-item">
                                                <a
                                                    class="nav-link {{ Request::is('tracki/setting/pay_cycle') ? 'active' : '' }}"
                                                    href="{{ route('tracki.setting.pay_cycle') }}">
                                                    <div class="d-flex align-items-center">
