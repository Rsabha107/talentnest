...
<div class="modal-body">
    ...
    <div class="col-md-12">
        ...
        <div class="col-md-12 mb-3">
            ...
            <input name="bank_branch_name" maxlength="50" class="form-control" type="text" placeholder="" value="{{$employee_bank->bank_branch_name}}" required>
            <!-- <div class="invalid-feedback">This field is required.</div> -->
        </div>
        <div class="col-md-12 mb-3">
            <label class="form-label" for="inputEmail4">Bank Account Name</label>
            <input name="bank_account_name" maxlength="50" class="form-control" type="text" placeholder="" value="{{$employee_bank->bank_account_name}}" required>
            <!-- <div class="invalid-feedback">This field is required.</div> -->
        </div>
        <div class="col-md-12 mb-3">
