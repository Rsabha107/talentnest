                                    ...
                                    <div class="col-xl-12">
                                        <div class="d-sm-flex justify-content-between">
                                            ...
                                            <div class="d-flex mb-3">
                                                <a class="btn btn-subtle-danger me-1 mb-1" href="{{ route('hr.emp.timesheet') }}">Cancel</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <form class="row g-3  px-3 needs-validation form-submit-event1" novalidate="" action="{{ route ('hr.emp.timesheet.entries.store') }}" method="POST">
                                @csrf
