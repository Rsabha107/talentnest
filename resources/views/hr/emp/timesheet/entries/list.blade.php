        ...
        <div>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-style1">
                    ...
                    <li class="breadcrumb-item"><a href="{{route('hr.emp.employee')}}">
                            <?= get_label('employees', 'Employees') ?></a>
                    </li>
                    <li class="breadcrumb-item"><a href="{{route('hr.emp.timesheet')}}">
...
<script src="{{asset('assets/js/pages/hr/emp/employees_timesheet_entry.js')}}"></script>
