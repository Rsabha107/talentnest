...
<!-- ===============================================-->
    ...
    <div class="container-fluid">
                ...
                <div>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-style1">
                            ...
                            <li class="breadcrumb-item"><a href="{{route('hr.admin.emergency')}}">
        ...
        <x-admin-employee-emergency-card employeeid="" />

    </div>

    <script src="{{asset('assets/js/pages/hr/admin/employees_emergency_contacts.js')}}"></script>
