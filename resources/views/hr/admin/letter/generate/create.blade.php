...
<!-- ===============================================-->
            ...
            <div>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-style1">
                        ...
                        <li class="breadcrumb-item"><a href="{{route('hr.admin.letter.generate')}}">
        ...
        <div class="row g-4">
            <div class="col-sm-6 col-md-6 col-lg-6">
                <div class="card border border-primary mb-3">
                    <div class="card-body">
                        <form class="row g-3  px-3 needs-validation form-submit-event" id="add_employee_letter_form" novalidate="" action="{{ route ('hr.admin.letter.generate.store') }}" method="POST">
                            @csrf
                            <div class="col-md-6">
    ...
    <script src="{{asset('assets/js/pages/hr/admin/employees_letter_generate.js')}}"></script>
