        ...
        <div class="col-md-12">
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    ...
                    <input name="employee_state" id="add_employee_state" maxlength="20" class="form-control" type="text" value="{{$employee_address->state}}" placeholder="State">
                </div>

                <div class="col-md-5">
                    <label class="form-label" for="inputEmail4">Zipcode</label>
                    <input name="employee_zipcode" id="add_employee_zipcode" class="form-control" type="text" value="{{$employee_address->zipcode}}" placeholder="00000">
                </div>
            </div>
            <div class="col-md-12 mb-3">
