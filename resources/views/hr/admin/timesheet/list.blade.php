...
<!-- ===============================================-->
    ...
    <div class="container-fluid">
        ...
        <!-- </div> -->
        <x-admin-employee-timesheet-card :employeetimesheets="$employee_timesheets" :employeeleavestatuses="$employee_leave_statuses" employeeid="" />
    </div>

    <script src="{{asset('assets/js/pages/hr/admin/employees_timesheet.js')}}"></script>
