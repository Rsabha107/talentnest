...
<!-- ===============================================-->
        ...
        <div>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-style1">
                    ...
                    <li class="breadcrumb-item"><a href="{{route('hr.admin.timesheet')}}">
    ...
    <!-- </div> -->
    <x-admin-employee-timesheet-entry-card :employeetimesheetentries='$employee_timesheet_entries' timesheetId="{{$employee_timesheets->id}}" />
</div>

<script src="{{asset('assets/js/pages/hr/admin/employees_timesheet_entry.js')}}"></script>
