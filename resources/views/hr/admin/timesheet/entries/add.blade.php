            ...
            <div>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-style1">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{route('hr.admin.employee')}}"><?= get_label('employee', 'Employee') ?></a>
                        </li>
                        <li class="breadcrumb-item">
                            <a href="{{route('hr.admin.timesheet')}}"><?= get_label('timesheet', 'timesheet') ?></a>
                        </li>
                                    ...
                                    <div class="col-xl-12">
                                        <div class="d-sm-flex justify-content-between">
                                            ...
                                            <div class="d-flex mb-3">
                                                <a class="btn btn-subtle-danger me-1 mb-1" href="{{ route('hr.admin.timesheet') }}">Cancel</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <form class="row g-3  px-3 needs-validation form-submit-event1" novalidate="" action="{{ route ('hr.admin.timesheet.entries.store') }}" method="POST">
                                @csrf
