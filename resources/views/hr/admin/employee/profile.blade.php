                                            ...
                                            <div class="table-responsive scrollbar">
                                                <table class="table table-sm fs-9 mb-0">
                                                    ...
                                                    <tbody class="list" id="customer-order-table-body">
                                                        ...
                                                        @if ($entries_count)
                                                        @php
                                                        $status = '<span class="badge badge-phoenix fs--2 badge-phoenix-' . $item->leave_statuses->color .
                                                                ' " style="cursor: not-allowed;" ><span class="badge-label">' . $item->leave_statuses->title .
                                                                '</span><span class="ms-1 uil-edit-alt" style="height:12.8px;width:12.8px;cursor: not-allowed;"></span></span>';
                                                        $status = '<td class="timesheet_status align-middle white-space-nowrap text-start fw-bold text-body-tertiary"><span class="badge badge-phoenix fs-10 badge-phoenix-'. $item->leave_statuses?->color .'"><span class="badge-label">'. $item->leave_statuses?->title .'</span><span class="ms-1" data-feather="check" style="height:12.8px;width:12.8px;"></span></span></td>';
                                                        ...
                                                        @php
                                                            ...
                                                            $status = '<td class="timesheet_status align-middle white-space-nowrap text-start fw-bold text-body-tertiary"><span class="badge badge-phoenix fs-10 badge-phoenix-secondary" style="cursor: not-allowed;"><span class="badge-label">Incomplete</span><span class="ms-1" data-feather="check" style="height:12.8px;width:12.8px;cursor: not-allowed;"></span></span></td>';
