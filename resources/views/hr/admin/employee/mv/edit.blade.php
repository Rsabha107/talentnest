<!-- <form class="row g-3  px-3 needs-validation form-submit-event" id="edit_employee_form" novalidate="" action="{{ route ('hr.admin.employee.store') }}" method="POST"> -->
<!-- @csrf -->
        ...
        <div class="col-md-8">
            ...
            <div class="mb-3 row">
                <div class="mb-3 col-md-12">
                    ...
                    <input name="first_name" maxlength="50" id="edit_employee_first_name" class="form-control" type="text" value="{{$emp->first_name}}" placeholder="" required>
                    <!-- <div class="invalid-feedback">This field is required.</div> -->
                </div>

                <div class="mb-3 col-md-12">
                    <label class="form-label" for="inputEmail4">Middle Name</label>
                    <input name="middle_name" maxlength="50" id="edit_employee_middle_name" class="form-control" type="text" value="{{$emp->middle_name}}" placeholder="">
                    <!-- <div class="invalid-feedback">This field is required.</div> -->
                </div>
                <div class="mb-3 col-md-12">
                    <label class="form-label" for="inputEmail4">Last Name</label>
                    <input name="last_name" maxlength="50" id="edit_employee_last_name" class="form-control" type="text" placeholder="" value="{{$emp->last_name}}" required>
                    <!-- <div class="invalid-feedback">This field is required.</div> -->
                </div>
                <div class="mb-3 col-md-6">
                    <label class="form-label" for="inputEmail4">Personal Email</label>
                    <input name="personal_email_address" maxlength="50" id="edit_personal_email_address" class="form-control" type="text" placeholder="" value="{{$emp->personal_email_address}}" required>
                    <!-- <div class="invalid-feedback">This field is required.</div> -->
                </div>
                <div class="mb-3 col-md-6">
                    <label class="form-label" for="inputEmail4">Work Email</label>
                    <input name="work_email_address" maxlength="50" id="edit_work_email_address" class="form-control" type="text" placeholder="" value="{{$emp->work_email_address}}" required>
                    <!-- <div class="invalid-feedback">This field is required.</div> -->
                </div>
                ...
                <div class="mb-3 col-md-6">
                    ...
                    <input name="passport_number" maxlength="50" class="form-control" type="text" placeholder="" value="{{$emp->passport_number}}" id="edit_employee_passport_number" required="required">
                    <!-- <div class="invalid-feedback">This field is required.</div> -->
                </div>
                <div class="mb-3 col-md-6">
                ...
                <div class="col-md-2 mb-3">
                    ...
                    <input name="phone_area_code" maxlength="10" id="phone_area_code" class="form-control" type="number" placeholder="" value="{{$emp->phone_area_code}}" required>
                    <!-- <div class="invalid-feedback">This field is required.</div> -->
                </div>
                <div class="col-md-4  mb-3">
                    <label class="form-label" for="inputEmail4">Phone</label>
                    <input name="phone_number" maxlength="25" id="edit_employee_phone_number" class="form-control" type="text" placeholder="" value="{{$emp->phone_number}}" required>
                    <!-- <div class="invalid-feedback">This field is required.</div> -->
                </div>
                <div class="col-md-2 mb-3">
                    <label class="form-label" for="alt_area_code">Code</label>
                    <input name="alt_area_code" maxlength="10" id="alt_area_code" class="form-control" type="number" placeholder="" value="{{$emp->alt_area_code}}">
                    <!-- <div class="invalid-feedback">This field is required.</div> -->
                </div>
                <div class="col-md-4  mb-3">
                    <label class="form-label" for="inputEmail4">Alternate Phone</label>
                    <input name="alt_phone_number" maxlength="25" id="edit_employee_alt_phone_number" class="form-control" type="text" value="{{$emp->alt_phone_number}}" placeholder="">
                    <!-- <div class="invalid-feedback">This field is required.</div> -->
                </div>
                <div class="mb-3 col-md-6">
                ...
                <div class="col-md-6  mb-3">
                    ...
                    <input name="sponsorship_name" maxlength="70" id="edit_employee_sponsorship_name" class="form-control" type="text" placeholder="" value="{{$emp->sponsorship_name}}">
                    <!-- <div class="invalid-feedback">This field is required.</div> -->
                </div>
                <div class="mb-3 col-md-12">
