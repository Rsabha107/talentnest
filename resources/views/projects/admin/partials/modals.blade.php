@if (Request::is('projects/admin/project') ||
    ...
    <div class="modal fade" id="add_project_modal" tabindex="-1" data-bs-backdrop="static"
        aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-top">
            <div class="modal-content bg-body-highlight">
                <div class="modal-header bg-modal-header">
                    <h3 class="mb-0" id="add_project_modal_label"><?= get_label('create_project', 'Create project') ?>
                    </h3>
                ...
                //
                ?>
                <form class="row g-3  px-3 needs-validation form-submit-event" id="add_project_form" novalidate=""
                    ...
                    @endif --}}
                        ...
                        <div class="mb-3 col-md-12">
                            ...
                            <input name="name" id="add_project_name" class="form-control" type="text"
                                placeholder="" required>
                        </div>
                        {{-- <div class="mb-3 row"> --}}
                        <div class="mb-3 col-md-12">
                            <label class="form-label" for="inputAddress2">Venues (multiple)</label>
                            <select required class="form-select js-select-project-venues-multiple"
                                id="add_project_venue" name="venue_id[]" multiple="multiple" data-with="100%"
                                data-placeholder="<?= get_label('Team', 'Team') ?>">
                        ...
                        <div class="mb-3 col-md-12">
                            ...
                            <select class="form-select js-select-project-fa-multiple" id="add_project_fa"
                                name="functional_area_id[]" multiple="multiple" data-with="100%"
                        ...
                        <div class="mb-3 col-md-12">
                            ...
                            <select required class="form-select js-select-project-assign-multiple"
                                id="add_project_assigned_to" name="assignment_to_id[]" multiple="multiple"
                        ...
                        <div class="mb-3 row">
                            <div class="col-sm-3 col-md-3">
                                ...
                                <select name="project_type_id" class="form-select" id="add_project_project_type"
                                    required>
                                    <option selected="selected" value="">Select...</option>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control datetimepicker" id="add_project_start_date"
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control datetimepicker" id="add_project_end_date"
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input name="budget_allocation" class="form-control"
                                    id="add_project_budget_allocation" type="number" step="0.01" placeholder=""
                                    value="0" required>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label" for="inputState">Attendance forcast</label>
                                <input name="attendance_forcast" class="form-control" id="add_project_attendance"
                                    type="number" step="0.01" placeholder="" value="0" required>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <label class="form-label" for="gridCheck">Description</label>
                            <textarea required name="description" class="form-control tinymce1" id="add_project_description" data-tinymce="{}"
    ...
    <div class="modal fade" id="edit_project_modal" tabindex="-1" data-bs-backdrop="static"
        aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-top">
            <div class="modal-content bg-body-highlight">
                <div class="modal-header bg-modal-header">
                ...
                <form class="row g-3  px-3 needs-validation form-submit-event" id="add_edit_project_form"
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-4">
                            <label class="form-label" for="inputAddress">Location</label>
                            <select name="location_id" class="form-select" id="add_edit_project_location"
                                required>
                                <option selected="selected" value="">Select...</option>
                                @foreach ($event_location as $key => $item)
                                    @if (Request::old('id') == $item->id)
                        ...
                        <div class="mb-3 row">
                            <div class="mb-3 col-md-6">
                                <label class="form-label" for="inputAddress2">Venues (multiple)</label>
                                <select required class="form-select js-select-project-venues-multiple"
                                    id="add_edit_project_venue" name="venue_id[]" multiple="multiple"
                                    data-with="100%" data-placeholder="<?= get_label('Team', 'Team') ?>">
                                    <option value="">Select venues</option>
                                    @foreach ($event_venue as $key => $item)
                                        <option value="{{ $item->id }}">
                            ...
                            <div class="mb-3 col-md-6">
                                <label class="form-label" for="inputAddress2">Functional Areas (multiple)</label>
                                <select class="form-select js-select-project-fa-multiple" id="add_edit_project_fa"
                                    name="functional_area_id[]" multiple="multiple" data-with="100%"
                                    data-placeholder="<?= get_label('Tags', 'Tags') ?>">
                                    <option value="">Select functional areas</option>
                                    @foreach ($functional_areas as $key => $item)
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-3 col-md-3">
                                <label class="form-label" for="inputAddress">Audience</label>
                                <select name="audience_id" class="form-select" id="add_edit_project_audience"
                                    required>
                                    <option selected="selected" value="">Select...</option>
                                    @foreach ($event_audience as $key => $item)
                                        @if (Request::old('id') == $item->id)
                        ...
                        <div class="mb-3 row">
                            ...
                            {{-- <div class="col-md-3">
                                <label class="form-label" for="inputAddress">Fund</label>
                                <select name="fund_category_id" class="form-select" id="add_edit_project_fund"
                                    required>
                                    <option selected="selected" value="">Select...</option>
                                    @foreach ($fund_category as $key => $item)
                                        @if (Request::old('id') == $item->id)
                            ...
                            <div class="col-md-3">
                                <label class="form-label" for="inputAddress">Budget</label>
                                <select name="budget_name_id" class="form-select" id="add_edit_project_budget"
                                    required>
                                    <option selected="selected" value="">Select...</option>
                                    @foreach ($budget_name as $key => $item)
                                        @if (Request::old('id') == $item->id)
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-6">
                                <label class="form-label" for="inputEmail4">Start Date</label>
                                <input class="form-control datetimepicker" id="add_edit_project_start_date"
                                    data-target="#floatingInputStartDate" name="start_date" type="date"
                                    placeholder="dd/mm/yyyy"
                                    data-options='{"disableMobile":true,"dateFormat":"d/m/Y"}' required>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label" for="inputEmail4">End Date</label>
                                <input class="form-control datetimepicker" id="add_edit_project_end_date"
                                    data-target="#floatingInputStartDate" name="end_date" type="date"
                                    placeholder="dd/mm/yyyy"
                                    data-options='{"disableMobile":true,"dateFormat":"d/m/Y"}' required>
                            </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-6">
                                <label class="form-label" for="inputCity">Budget allocated</label>
                                <input name="budget_allocation" class="form-control"
                                    id="add_edit_project_budget_allocation" type="number" step="0.01"
                                    placeholder="" value="0" required>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label" for="inputState">Attendance forcast</label>
                                <input name="attendance_forcast" class="form-control"
                                    id="add_edit_project_attendance" type="number" step="0.01" placeholder=""
                                    value="0" required>
                            </div>
                        </div>
                        <div class="col-md-12">
...
@if (Request::is('tracki/setup/workspace'))
    ...
    <div class="modal fade" id="create_workspace_modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <form novalidate="" class="modal-content form-submit-event needs-validation" id="form_submit_event"
                action="{{ route('tracki.setup.workspace.store') }}" method="POST">
                <input type="hidden" name="table" value="workspace_table">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel1">
                        <?= get_label('create_workspace', 'Create workspace') ?></h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                @csrf
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            <select class="form-select js-example-basic-multiple" name="assigned_to_id[]"
    ...
    <div class="modal fade" id="edit_workspace_modal" tabindex="-1" data-bs-backdrop="static"
        aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <form novalidate="" class="modal-content form-submit-event needs-validation" id="form_submit_event"
                action="{{ route('tracki.setup.workspace.update') }}" method="POST">
                <input type="hidden" name="table" value="workspace_table">
                <input type="hidden" id="id" name="id" value="">
                <input type="hidden" id="table" name="table">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel1">
                        <?= get_label('edit_workspace', 'Edit workspace') ?></h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                @csrf
                <div class="modal-body">
                    <div class="row">
                        <div class="col mb-3">
                            <label for="nameBasic" class="form-label"><?= get_label('title', 'Title') ?> <span
                                    class="asterisk">*</span></label>
                            <input type="text" id="edit_ws_title" class="form-control" name="title"
                                placeholder="<?= get_label('please_enter_title', 'Please enter title') ?>" />
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="mb-3">
                            <label class="form-label" for="user_id"><?= get_label('select_users', 'Select users') ?>
                                <span id="task_update_users_associated_with_project"></span></label>
                            <select id="edit_ws_asg_id" class="form-select js-asg-basic-multiple"
                                name="assigned_to_id[]" multiple="multiple"
                                data-placeholder="<?= get_label('type_to_search', 'Type to search') ?>">
                                <option value="">Select Assinged to</option>
                                @foreach ($employees as $key => $item)
                                    <option value="{{ $item->id }}">
                    ...
                    <div class="row">
                        <div class="mb-3">
                            <label class="form-label"
                                for="user_id"><?= get_label('select_clients', 'Select clients') ?> <span
                                    id="task_update_users_associated_with_project"></span></label>
                            <select id="edit_ws_client_id" class="form-select js-client-basic-multiple"
    ...
    <div class="modal fade" id="add_task_modal" tabindex="-1" data-bs-backdrop="static"
        ...
        <div class="modal-dialog modal-lg modal-dialog-top">
            <div class="modal-content bg-body-highlight">
                ...
                //
                ?>
                <form class="row g-3  px-3 needs-validation form-submit-event" id="add_task_form" novalidate=""
                    ...
                    <div class="modal-body">
                        ...
                        @if ($projects instanceof \Illuminate\Database\Eloquent\Collection)
                            ...
                            <div class="mb-3 col-12">
                                ...
                                <select name="project_id" id="add_task_event_id"
                                    onChange="getProjectUsers(this.value);" class="form-select"
                                    id="floatingSelectRating" required>
                                    <option selected="selected" value="">Select...</option>
                        ...
                        <div class="mb-3 col-md-12">
                            <label class="form-label" for="inputEmail4">Title</label>
                            <input name="name" id="add_task_name" class="form-control" type="text"
                                placeholder="" required>
                        </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-6">
                                <label class="form-label" for="inputEmail4">Start Date</label>
                                <input class="form-control datetimepicker" id="add_task_start_date"
                                    data-target="#floatingInputStartDate" name="start_date" type="date"
                                    placeholder="dd/mm/yyyy"
                                    data-options='{"disableMobile":true,"dateFormat":"d/m/Y"}' required>
                            </div>
                            <div class="col-md-6">
                                ...
                                <input class="form-control datetimepicker" id="add_task_due_date"
                                    data-target="#floatingInputStartDate" name="due_date" type="date"
                                    placeholder="dd/mm/yyyy"
                                    data-options='{"disableMobile":true,"dateFormat":"d/m/Y"}' required>
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="department_assignment_id" id="add_task_department_id"
                                    class="form-select" id="floatingSelectRating" required>
                                    <option selected="selected" value="">Select...</option>
                        ...
                        <div class="mb-3 row">
                            <div class="col-md-6">
                                ...
                                <select name="venue_id" class="form-select" id="add_task_venue" required>
                                    <option selected="selected" value="">Select...</option>
                                    @foreach ($event_venue as $key => $item)
                                        @if (Request::old('id') == $item->id)
                                            <option value="{{ $item->id }}" selected>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="functional_area_id" id="add_task_fa" class="form-select"
                                    id="floatingSelectRating" required>
                                    <option selected="selected" value="">Select...</option>
                                    @foreach ($functional_areas as $key => $item)
                                        @if (Request::old('id') == $item->id)
                        ...
                        {{-- <div class="mb-3 col-md-12">
                        <label class="form-label" for="inputAddress2">Venues (multiple)</label>
                        <select required class="form-select js-select-venues-multiple" id="add_project_venue" 
                                    name="venue_id[]" multiple="multiple" data-with="100%" data-placeholder="<?= get_label('Select', 'Select ...') ?>">
                    ...
                    <div class="mb-3 col-md-12">
                        ...
                        <div class="mb-3 col-md-12">
                            <label class="form-label" for="inputAddress2">Assign to (multiple)</label>
                            <select required class="form-select js-select-task-assign-multiple"
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-6">
                                <label class="form-label" for="inputCity">Budget allocated</label>
                                <input name="budget_allocation" class="form-control" id="add_task_budget"
                                    type="number" step="0.01" placeholder="" value="0" required>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label" for="inputState">Actual budget utilized</label>
                                <input name="actual_budget_allocated" class="form-control"
                                    id="add_task_budget_utilization" type="number" step="0.01"
                                    placeholder="" value="0" required>
                            </div>
                        </div>
                        <!-- <h4 class="mt-6">Other Information</h4> -->
                        ...
                        <div class="col-12">
                            <label class="form-label" for="gridCheck">Description</label>
                            <textarea style="height: 200px;" required name="description" class="form-control tinymce1"
                                id="add_task_description" data-tinymce="{}" placeholder=""></textarea>
                        </div>
                    </div>
