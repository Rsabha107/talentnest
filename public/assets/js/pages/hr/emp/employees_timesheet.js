...
$(document).ready(function () {
    ...
    $("body").on(
        ...
        function () {
            ...
            $.ajax({
                url: "/hr/manager/timesheet/entries/mv/get/" + id,
                method: "GET",
                async: true,
                success: function (response) {
                    g_response = response.view;
    ...
    $("body").on("click", "#payroll_timesheet_check", function () {
        ...
        $.ajax({
            url: "/hr/payroll/timesheet/review/" + id,
            method: "GET",
            async: true,
            success: function (response) {
                toastr.success(response["message"]);
    ...
    $("body").on("click", "#edit_employee_timesheet", function () {
        ...
        $.ajax({
            url: "/hr/emp/timesheet/mv/edit/" + id,
            method: "GET",
            async: true,
            success: function (response) {
                g_response = response.view;
    ...
    $("body").on("click", "#editTimesheetStatus", function (event) {
        ...
        $.get("/hr/emp/timesheet/status/edit/" + id, function (data) {
    ...
    $("body").on("click", "#deleteTimesheet", function (e) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "/hr/emp/timesheet/delete/" + id,
                    method: "GET",
