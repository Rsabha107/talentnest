...
class PayCycleController extends Controller
{
    ...
    {
        return view('hr.admin.setting.paycycle.list');
    }

    public function get($id)
    {
        $op = PayrollPeriod::findOrFail($id);
    ...
    public function update(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            $op = PayrollPeriod::findOrFail($request->id);
    ...
    public function store(Request $request)
    {
        ...
        if ($validator->fails()) {
            // Log::info($validator->errors());
            $error = true;
            // $message = 'Pay Cycle could not be created';
            $message = implode($validator->errors()->all());
        } else {

            $error = false;
            $message = 'Pay Cycle created.';
    ...
    public function list()
    {
        ...
        $op = PayrollPeriod::orderBy($sort, $order);
