...
class DesignationController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('hr.admin.setting.designations.list', compact('departments', 'designations'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            $designation->department_id = intval($request->department_id);
    ...
    public function delete($id)
    {
        ...
        return response()->json(['error' => $error, 'message' => $message]);
        // return redirect()->route('hr.admin.setup.workspace')->with($notification);
    } // delete
