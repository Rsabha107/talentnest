...
class PrefixController extends Controller
{
    ...
    {
        return view('hr.admin.setting.prefix.list');
    }

    public function get($id)
    {
        $op = Salutation::findOrFail($id);
    ...
    public function update(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            $error = true;
            // $message = 'Prefix not create.';
            $message = implode($validator->errors()->all());
        } else {
            $user_id = Auth::user()->id;
            $op = Salutation::findOrFail($request->id);
    ...
    public function store(Request $request)
    {
        ...
        if ($validator->fails()) {
            // Log::info($validator->errors());
            $error = true;
            // $message = 'Prefix could not be created';
            $message = implode($validator->errors()->all());
        } else {
    ...
    public function list()
    {
        ...
        $op = Salutation::orderBy($sort, $order);
