...
use App\Models\ElementSetAssignment;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Auth;
use Illuminate\Support\Facades\Validator;

class ElementSetAssignmentController extends Controller
{
    //
    public function index()
    {
        ...
        return to_route('tracki.setting.elementset.assignment.list', ['id' => 1]);
    }
    ...
    public function list($id=null)
    {
        ...
        $op = $op->paginate(request("limit"))->through(function ($op) {
            ...
            '<a href="'.route('tracki.setting.elementset.assignment').'" class="btn btn-sm" data-action="assign" data-type="edit" data-id=' .
            $op->id .
    ...
    public function AssignElements(){
        return view('tracki.setting.elementset.assign_elements');
    }
}
